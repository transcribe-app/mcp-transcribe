export function coalesce(value, def) {
...
export function safeFloat(text){
...
export function safeStr(text, maxLength = -1, doTrim = false){
	if(text == null){
		return "";
	}
	if(!isString(text)){
...
export function toArray(input, withReverse = false) {
	var ret = new Array();
...
var _global_cnt = 0;
export function uiccstamp(){
	_global_cnt++;
	return _global_cnt;
}
export function unixstamp(forDate = null){
	if(forDate == null){
		forDate = new Date();
	}
...
export function dbgTYPE(obj) {
	return Object.prototype.toString.call(obj).match(/\s\w+/)[0].trim();
}
	
export function dbgJSON(object){
...
var clog_lines = [];
export function get_clog() {
	return clog_lines;
}
export function clog(itm1,itm2,itm3,itm4,itm5) {
	if(itm5 != null){
...
export function dateTimeString(unixstamp) {
	return dateString(unixstamp,true);
}

export function dateString(unixstamp, withTime = null) {
...
export function strContainsOnly(str, charset) {
	return str.split('').every(function(ch) {
	  return charset.indexOf(ch) !== -1;
	});
}

export function strContainsAny(str, charset) {
	return str.split('').some(function(ch) {
	  return charset.indexOf(ch) !== -1;
	});
}

export function strHash(keyString)
{
...
export function strMD5(inputString) {
...
export function strFromPercent(frac){
	var perc_num = parseInt(frac*100.0, 10);
	return ""+perc_num+"%";
}

export function strFromTime(time){
	time = safeFloat(time);
...
export function strFromNumber(prefix, n, fractDigits) {
...
export function isBrowserSafary() {
	if(!isBrowser()){
		return false;
	}
...
export function isBrowserIosApp() {
	if(!isBrowser()){
		return false;
	}
...
export function isBrowserDev(hostname) {
	if(isDev()){
		return 2;
	}
...
export function replaceAll(str, what, towhat) {
	if(str == null){
		return "";
	}
	if(what == null){
...
export function dbgSaveBlob(blob, fileName){
...
export function isYoutubeUrl(inUrl){
